...
const REPLY_RULES: ReadonlyArray<{
  ...
  },
  {
    ...
    pattern: /(?:你|这)(?:已经|一定|肯定)?(?:确诊|患有)|(?:保证|一定可以).{0,8}(?:治愈|治好)|停止服药|无需就医|法律建议|(?:给出|下).{0,4}医学结论|(?:你|这)(?:就)?是(?:焦虑症|抑郁症|多动症|心理疾病|精神病)|(?:不必|不用|不需要).{0,6}(?:就医|看医生|找医生|寻求专业帮助)|按我的方法治疗|我来(?:治疗|治愈|诊断)|(?:替代|代替)医生/iu,
  },
  {
    reason: "age_inappropriate_content",
    pattern: /露骨|性暗示|成人(?:化)?(?:内容|话题|语气|描写|表达|暗示)|不适合未成年人|挑逗|暧昧(?:语气|描写|表达)|用成人.{0,8}(?:方式|语气|内容).{0,8}(?:解释|回答|描写)/iu,
  },
  {
