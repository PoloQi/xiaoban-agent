  ...
  oneOf: [
    ...
    },
    {
      ...
      properties: {
        schemaVersion: { type: "string", const: CHILD_CHAT_SCHEMA_VERSION },
        requestId: { type: "string", format: "uuid" },
        route: { type: "string", const: "activity_recommendations" },
    ...
    },
    {
      ...
      properties: {
        schemaVersion: { type: "string", const: CHILD_CHAT_SCHEMA_VERSION },
        requestId: { type: "string", format: "uuid" },
        route: { type: "string", const: "lonely_connection" },
        reply: { type: "string", minLength: 1, maxLength: 800 },
        connectionLabel: { type: "string", minLength: 1, maxLength: 12 },
        contactIntention: { type: "string", enum: ["trusted_adult", "self_record"] },
